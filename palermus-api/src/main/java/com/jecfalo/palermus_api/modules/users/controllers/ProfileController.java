...
public class ProfileController {
    ...
    public ResponseEntity<Page<ListProfile>> getProfilesActive(@PageableDefault(size = 10, page = 0, sort = "profileId", direction = Sort.Direction.DESC)Pageable pageable){
        Page<ListProfile> listProfilePage = service.loadAllActive(pageable);
        return ResponseEntity.ok(listProfilePage);
    }
